    ...
    <div className="apropos">
      <main>
        ...
        <section id="nos-services">
          <h2>Nos Services</h2>
          <p>
            Chez Playpal, nous proposons une vaste sélection de jeux de société
            à louer, allant des classiques aux dernières nouveautés. Que vous
            soyez un joueur occasionnel ou un passionné de longue date, vous
            trouverez chez nous des jeux qui vous captiveront.
          </p>
          <ul>
            <li>
              <strong>Location de Jeux</strong> : Louez vos jeux de société
              préférés pour une soirée, un week-end ou plus. Nous avons des jeux
              pour tous les goûts et tous les âges.
            </li>

            <li>
              <strong>Événements</strong> : Nous organisons également des
              soirées jeux et des événements spéciaux pour rassembler les
              amateurs de jeux de société.
            </li>
          </ul>
        </section>

        <section id="notre-engagement">
          <h2>Notre Engagement</h2>
          <p>
            Nous nous engageons à offrir un service de qualité, avec des jeux en
            excellent état et un service clientèle attentif. Nous croyons en la
            puissance des jeux de société pour créer des moments de bonheur et
            de connexion, et nous sommes déterminés à rendre ces moments
            accessibles à tous.
          </p>
          <p>
            Merci de faire partie de notre aventure. Nous avons hâte de partager
            avec vous notre passion pour les jeux de société et de vous aider à
        ...
        <section id="contactez-nous">
          ...
          <p>
            Pour toute question ou demande spéciale, n'hésitez pas à nous
            contacter. Nous sommes là pour vous aider à trouver le jeu parfait
            pour votre prochaine soirée.
          </p>
          <ul>
            <li>
              <strong>Email</strong> :{' '}
              <a href="mailto:contact@playpal.com">contact@playpal.com</a>
            </li>
            <li>
              <strong>Téléphone</strong> : +33 1 23 45 67 89
            </li>
            <li>
              <strong>Adresse</strong> : 123 Rue des Jeux, 75001 Paris, France
            </li>
          </ul>
        </section>
      </main>
